Public Class frm_orders_a189479
    Private Sub frm_orders_a189479_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim mysql As String = "SELECT * FROM TBL_ORDER_A189479"
